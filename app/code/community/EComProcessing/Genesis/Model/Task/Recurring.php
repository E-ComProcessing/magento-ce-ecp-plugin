...
/**
 * EComProcessing Recurring Module Observer
 * Class EComProcessing_Genesis_Model_Task_Recurring
 */
class EComProcessing_Genesis_Model_Task_Recurring
{
    /**
     * @var EComProcessing_Genesis_Helper_Data
     */
    protected $_helper;
